var e = "[[b;#44D544;]root]&#64;digitaldisarray&#46;github&#46;io";
var App = {
    echo: function(text) {
        this.echo(text);
    ...
    help: function() {
      showHelp(this);
        ...
        ls: function() {
            ...
            this.echo('disarray_Private.pgp');
            this.echo('passwords.txt');
			this.echo('hs_err_pid.txt');
    ...
    shutdown: function() {
        ...
        setTimeout(function(){ document.location.href = 'https://digitaldisarray.github.io/'; }, 2500);
        if(ga != undefined) ga('send', 'event', 'shutdown');
    },
    env: function() {
        this.echo("[[b;#44D544;]NAME=DigitalDisarray\nTITLE=FullStackDeveloper;SecurityResearcher\nGITHUB=https://github.com/digitaldisarray\n_=/usr/bin/env]");
    ...
    github: function() {
        ...
        setTimeout(function(){ document.location.href = 'https://github.com/digitaldisarray'; }, 1000);
        if(ga != undefined) ga('send', 'event', 'env');
    }//,
    //publicPGPkey: function() {
...
jQuery(document).ready(function($) {
		...
		"██. ██ ▐█▌▐█▄▪▐█▐█ ▪▐▌▐█•█▌▐█•█▌▐█ ▪▐▌ ▐█▀·.\n"+
		"▀▀▀▀▀• ▀▀▀ ▀▀▀▀  ▀  ▀ .▀  ▀.▀  ▀ ▀  ▀   ▀ • \n"+
		"Welcome to Digital Disarray's personal website!\n\n"+
		"Quick Commands\n"+
		"\techo          env          help\n"+
		"\tid           ls           whoami]\n\n"+
		"[[b;#44D544;]root]&#64;digitaldisarray&#46;github&#46;io:~# env\n[[b;#44D544;]TITLE=FullStackDeveloper;SecurityResearcher\nGITHUB=https://github.com/digitaldisarray\n_=/usr/bin/env]",
                prompt: function(p){
            var path = '~'
            p(e + ":" + path + "# ");
        },
